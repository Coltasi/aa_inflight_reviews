  ...
  return (
    <div className={s.page}>
      <div className={s.wrap}>
        ...
        <p>
          Flight entertainment data comes from <a href="https://entertainment.aa.com" target="_blank" rel="noopener noreferrer">American Airlines</a>. Movie scores are sourced from the <a href="https://www.omdbapi.com" target="_blank" rel="noopener noreferrer">OMDB API</a>, which aggregates data from Rotten Tomatoes and IMDb. Scores reflect critic consensus at the time of lookup and may not match exactly what appears on those sites.
        </p>

        <h2 className={s.h2}>Contact</h2>
        <p>
          Questions or feedback? Reach out at <a href="mailto:hello@thecabincritic.com">hello@thecabincritic.com</a>.
        </p>
